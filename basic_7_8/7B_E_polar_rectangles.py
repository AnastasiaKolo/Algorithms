...
# *просто так не удалось - теперь ML на 52 тесте (69 mb) //в тесте 100 000 прямоугольников компилятор 3.7 PyPy
# также удаляю лишнюю инфу из events_fi - неважно, все равно ML на 52 тесте (65 mb)
# *прошло на компиляторе 3.9 без нарушения по memory limit (вписалось в 63.80Mb) мое лучшее место в рейтинге 34
#
...
# - https://youtu.be/r5mRCMLY_L4?t=1536 досмотреть
